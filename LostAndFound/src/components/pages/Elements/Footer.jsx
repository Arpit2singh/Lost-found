        ...
        <div className="flex space-x-10">
          <div className="flex flex-col items-start">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-yellow-500 transition-colors">Find Items</a></li>
              <li><a href="#" className="hover:text-yellow-500 transition-colors">Report Lost Item</a></li>
